        ...
        <div className="withdraw-container">
            <div className="withdraw-box">
                ...
                <form className="withdraw-form">
                    ...
                    <div className="balance-container"> 
                        <label className="field-label" htmlFor="balance">Enter the Credit Card Information for your Amount to Return </label>
                    </div>
                    <div className="balance-container"> 
                    ...
                    <div className="balance-container"> 
                        ...
                        <input className="withdraw-input" type="month" id="expiration_date" placeholder="Expiration Date" required/>
                    </div>
                    <div className="balance-container"> 
